...
mydb = my.connect(host='localhost', user='root', passwd='SMARTwatch0987', autocommit=True)
...
JOB varchar(20),CATAGORY varchar(20),DEPARTMENT varchar(20),SUB_DIV varchar(25),SALARY decimal,COMM decimal,
HIREDATE date)"""
        mycursor.execute(query)
...
def insert_staff():
    while True:
        ...
        catagory = input('Enter The Sub Division Of The Job  :  ').upper()
        dept = input('Enter The Name Of The Department :  ').upper()
        sub_div = input('Enter The Sub Division Of The Department :  ').upper()
        sal = float(input('Enter The Salary Per Month : '))
        comm = float(input('Enter The Commission Per Month :  '))
        hiredate = get_hiredate()
        query = f"""insert into hospital_staff values('{sid}','{name}','{job}','{catagory}','{dept}',
'{sub_div}',{sal},{comm},'{hiredate}')"""
        mycursor.execute(query)
...
WEIGHT : {weight}kg                     D.O.A : {doa}                       DATED : {dod}
    ...
    the doctor or else, it may lead from mild to severe consequences. 
         ...
         |  Total Price Of Medication :          |             {price_med}    | 
         |  Doctors' Fee :                       |             {doctor_fee}   | 
         |  Total Amount Of The Tests Done :     |             {test_fee}     | 
         |  Discount Applied :                   |             {discount}%    |
         |  Total Payable Amount                 |             {total_amo}    | 
         +---------------------------------------+----------------------------+""")
                del_rec(pid)
...
def display_staff():
    try:
        ...
        if c == 0:
            ...
            print('\n')
            print('|ID'.ljust(15), '|Name'.ljust(15), '|Job'.ljust(15), '|Catagory'.ljust(15), '|Department'.ljust(15),
                  '|Sub Dept'.ljust(15), '|Salary'.ljust(15), '|Comm'.ljust(15), '|Hiredate '.ljust(15), end='|')
            for x in myrecords:
                print('\n', end='|')
                for i in x:
...
def search_staff():
    try:
        ...
        if mycursor.rowcount != 0:
            for x in myrecords:
                print('|ID'.ljust(15), '|Name'.ljust(15), '|Job'.ljust(15), '|Catagory'.ljust(15),
                      '|Department'.ljust(15),
                      '|Sub Dept'.ljust(15), '|Salary'.ljust(15), '|Comm'.ljust(15), '|Hiredate '.ljust(15), end='|')
                print('\n', end='|')
                for i in x:
...
def search_patients():
    ...
    if mycursor.rowcount != 0:
        for x in myrecords:
            print('|ID'.ljust(15), '|PNAME'.ljust(15), '|PAGE'.ljust(15), '|PGENDER'.ljust(15), '|PWEIGHT'.ljust(15),
                  '|PDOA'.ljust(15), '|ILLNESS'.ljust(15), '|CONSULTANT_DR'.ljust(15), '|DIAGNOSIS'.ljust(15),
                  '|ADMN_FEE'.ljust(15), end='|')
            print('\n', end='|')
            for i in x:
                print(str(i).ljust(15), end='|')
    else:
...
def display_discharged():
    try:
        ...
        if mycursor.rowcount == 0:
            ...
            myrecords = mycursor.fetchall()
            print('|ID'.ljust(15), '|P_NAME'.ljust(15), '|P_AGE'.ljust(15), '|P_GENDER'.ljust(15), '|REASON'.ljust(15),
                  '|ILLNESS'.ljust(15), '|DIAGNOSIS'.ljust(15), '|COND'.ljust(15), '|CONSULTANT_DR'.ljust(15),
                  '|P_DOA'.ljust(15), '|P_DOD'.ljust(15))
            for x in myrecords:
                print('\n', end='|')
                for i in x:
                    print(str(i).ljust(15), end='|')
